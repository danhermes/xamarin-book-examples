...
{
    [Activity(Label = "ListCustomAdapter")]
    public class ListCustomAdapter : BaseAdapter
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.title).Text = itemList[position].Title;
            view.FindViewById<TextView>(Resource.Id.description).Text = itemList[position].Description;
            return view;
        }
